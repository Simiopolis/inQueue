...
//		bar.addTab(bar.newTab().setText("ListFragment").setTabListener(this));
//		bar.addTab(bar.newTab().setText("Blah").setTabListener(this));
...
//		getFragmentManager().beginTransaction().replace(R.id.container, restaurantFragment).commit();
//	}
//
//	@Override
